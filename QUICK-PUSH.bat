...
if not exist "MEGA-FINAL-COMPLETE-SYSTEM.html" (
    echo ERROR: MEGA-FINAL-COMPLETE-SYSTEM.html not found!
    echo Please download it first and put in this folder.
    pause
    exit /b 1
)

echo Step 1: Renaming to index.html...
ren MEGA-FINAL-COMPLETE-SYSTEM.html index.html
echo Done!
echo.
...
echo ========================================
echo.
set /p REPO_URL="Your GitHub URL: "
